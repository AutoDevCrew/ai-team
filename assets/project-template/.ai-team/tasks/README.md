...
1. Copy the task-card structure from `../governance/templates.md` without renaming its required headings or fields.
2. Give the card a unique ID and add its unique link to `backlog.md`.
3. Follow `../governance/workflow.md` for lanes, states, gates, handoffs, validation, batching, completion, and re-entry.
4. Follow `../governance/roles.md` for who may write the card, backlog, code, tests, findings, and verdicts.
5. Keep the Handoff Snapshot current and place raw or historical material behind its Evidence index.
