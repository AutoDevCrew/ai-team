...
7. The independent verifier records a scoped PASS; authors do not approve their own artifacts.
...
3. The task has a fresh independent implementation-readiness PASS.
...
- Only after the scoped review has no deterministic P0/P1 does the verifier run one fresh approved full suite and applicable independent risk tests. Reviewers do not duplicate that full suite unless evidence is invalid.
