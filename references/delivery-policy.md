...
1. Platforms, language/runtime/package manager, frameworks, module boundaries, transport/data/auth/configuration boundaries, local commands, test frameworks, environment/data/reset, external constraints, and the Schema-declared external-integration credential-readiness fields/table are complete or explicitly inapplicable.
